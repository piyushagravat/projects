            ...
            <div class="col-xs-12">
		     ...
		     ?>
                    <tr>
					  ...
					  <th><a href="<?php  echo base_url(); ?>whatsnew/viewimages/<?php echo $item->id; ?>"><span class="label label-primary">View Image</span></a></th>
                      <th><?php if($item->status == "Disable") { ?> <a href="<?php echo base_url(); ?>whatsnew/action1/<?php echo $item->id; ?>/Enable"><span class="label label-success">Enable Product ?</span></a><?php } else { ?><a href="<?php echo base_url(); ?>whatsnew/action1/<?php echo $item->id; ?>/Disable"><span class="label label-success">Disable Product ?</span></a><?php } ?> &nbsp; <a href="<?php echo base_url(); ?>whatsnew/delete/<?php echo $item->id; ?>/<?php echo $offset; ?>" onclick="return confirm('Are you sure you want to remove products from what's new?')"><span class="label label-danger">Delete</span></a>&nbsp; <a href="<?php echo base_url(); ?>whatsnew/edit/<?php echo $item->id; ?>/<?php echo $offset; ?>"><span class="label label-warning">Edit</span></a></th>
                    </tr>
                    <?php $i++; } ?>
