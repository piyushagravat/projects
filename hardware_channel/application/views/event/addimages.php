...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $event->event_title; ?> - Add New Images</li>
          </ol>
        </section>
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title"><?php echo $event->event_title; ?> - Add New Images</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="<?php echo base_url()."event/addrecord_images"; ?>"  enctype="multipart/form-data"  onSubmit="return check()">
