...
<!--                      <th>Products Code</th>-->
                    ...
                    <tr>
                      ...
                      <th><a href="<?php echo base_url(); ?>product/delete/<?php echo $item->pid; ?>" onclick="return confirm('Are you sure you want to delete?')"><span class="label label-danger">Delete</span></a> &nbsp; <a href="<?php echo base_url(); ?>product/edit/<?php echo $item->pid; ?>"><span class="label label-warning">Edit</span></a></th>
                    </tr>
                    <?php $i++;} ?>
                     <tr>
                    <td colspan="7">
