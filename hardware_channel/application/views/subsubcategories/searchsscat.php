            ...
            <div class="col-xs-12">
				...
				<div class="box-header" style="width:50%">
				  <form action="<?php echo base_url(); ?>subsubcategories/searchsscat" method="post">
                    <div class="input-group">
                      <input type="text" name="searchsubsubcategories" placeholder="Search by Sub-Sub-Categories Name" class="typeahead form-control"  autocomplete="off" spellcheck="false" />
		     ...
		     ?>
                    <tr>
					  ...
					  <th><a href="<?php echo base_url(); ?>subsubcategories/delete/<?php echo $item->sscat_id; ?>" onclick="return confirm('Are you sure you want to delete?')"><span class="label label-danger">Delete</span></a> &nbsp; <a href="<?php echo base_url(); ?>subsubcategories/edit/<?php echo $item->sscat_id; ?>"><span class="label label-warning">Edit</span></a></th>
                    </tr>
                    <?php $i++; } ?>
