...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Manage Categories Images
	    </h1>
          <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="<?php echo base_url(); ?>categories">Manage Whatsnew Product Full Images</a></li>
            <li class="active"><?php echo $whatsnew->pname; ?> - Add New Whatsnew Product Full Images</li>
          </ol>
        </section>
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title"><?php echo $whatsnew->pname; ?> - Add New Images</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="<?php echo base_url()."whatsnew/addrecord_images"; ?>"  enctype="multipart/form-data"  onSubmit="return check()">
                <input type="hidden" name="pid" value="<?php echo $whatsnew->id; ?>"  />
                  <div class="box-body">
