                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    <tr>
                      ...
                      <th width="10%">Manufacturer Name</th>
                    ...
                    <?php $i=1; foreach($viewdata as $item) {
                        $AdsManf = $this->userModel->get_user_by_id($item->mid)->row();						
						$ProdManf = $this->userModel->get_user_by_prodid($item->pid)->row();
                    ...
                    <tr>
                      ...
                      <td>
					  <?php if($item->inquiry_type == 'Product') { echo $ProdManf->company_name; }else { echo $AdsManf->company_name; } ?>
                      </td>
                      ...
                      <th><a href="<?php echo base_url(); ?>users/delete/<?php echo $item->id; ?>/<?php echo $offset; ?>" onclick="return confirm('Are you sure you want to delete?')"><span class="label label-danger">Removed Inquiry</span></a></th>
