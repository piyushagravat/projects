            ...
            <div class="col-xs-12">
              <div class="box">
				<div class="box-header" style="width:50%">
                  <form action="<?php echo base_url(); ?>reports/search_adsinquiry" method="post">
                    <div class="input-group">
                      <input type="text" name="searchads" placeholder="Search by Ads Name" class="typeahead form-control"  autocomplete="off" spellcheck="false" />
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
					...
					$clientinfo = $this->inquiryModel->get_user_by_id($item->id)->row();
