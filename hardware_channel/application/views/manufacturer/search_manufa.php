				...
				<div class="box-header" style="width:50%">
                  <form name="manuf"  action="<?php echo base_url(); ?>manufacturer/search_manufa" method="post" onsubmit="return validation(this)">
                    <div class="input-group">
                      <input type="text" name="searchmanufacturer" placeholder="Search by Manufacturer Comapny Name" class="typeahead form-control"  autocomplete="off" spellcheck="false" required="required" />
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
					  ...
					  <th><a href="<?php echo base_url(); ?>manufacturer/delete/<?php echo $item->id; ?>" onclick="return confirm('Are you sure you want to delete?')"><span class="label label-danger">Delete</span></a> &nbsp; <a href="<?php echo base_url(); ?>manufacturer/edit/<?php echo $item->id; ?>"><span class="label label-warning">Edit</span></a></th>
                    </tr>
                    <?php $i++; } ?>
