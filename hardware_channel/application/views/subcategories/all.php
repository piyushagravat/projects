            ...
            <div class="col-xs-12">
		     ...
		     ?>
                    <tr>
					  ...
					  <th><a href="<?php echo base_url(); ?>subcategories/delete/<?php echo $item->subcat_id; ?>/<?php echo $offset; ?>" onclick="return confirm('Are you sure you want to delete?')"><span class="label label-danger">Delete</span></a> &nbsp; <a href="<?php echo base_url(); ?>subcategories/edit/<?php echo $item->subcat_id; ?>/<?php echo $offset; ?>"><span class="label label-warning">Edit</span></a></th>
                    </tr>
                    <?php $i++; } ?>
