                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                     <td><?php echo $i+$num; ?></td>					  
                      ...
                      <th><a href="<?php echo base_url(); ?>dealer/delete/<?php echo $item->id; ?>/<?php echo $offset; ?>" onclick="return confirm('Are you sure you want to delete?')"><span class="label label-danger">Delete</span></a> &nbsp; <a href="<?php echo base_url(); ?>dealer/edit/<?php echo $item->id; ?>/<?php echo $offset; ?>"><span class="label label-warning">Edit</span></a></th>
                        </tr>
                    <?php $i++; } ?>
