              ...
              <div class="box box-primary">
                ...
                <form role="form" method="post" action="<?php echo base_url()."whatsnew/addrecord"; ?>"  enctype="multipart/form-data" onSubmit="return check()">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="exampleInputFile">Upload Product Banner Image (300 x 300)</label>
                    ...
                    <div class="form-group">
                      <label for="exampleInputFile">Upload Product Full Screen Image (600 x 240)</label>
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Detail</label>
                        <textarea class="form-control" id="txtdetail" name="txtdetail" placeholder="Enter Detail" ><?php echo set_value('txtdetail');  ?></textarea>
